__includes ["bdi.nls" "communication.nls" "positioning.nls" "environment.nls" "Drones.nls" "Houses.nls" "ethical_eval.nls" "People.nls" "utils.nls"]

extensions [fuzzy]

globals [

  packages-left packages-dropped packages-damaged packages-returned

  currently-people currently-drones currently-warehouses
...
patches-own [
  ...
  road passable? next-to-road
  distance-to-factory distance-to-house distance-to-airport distance-to-main-road distance-to-forest distance-to-square distance-to-nearest-person
  patch-legality
  altitude
...
to setup
  clear-all
  set currently-people 0
  set currently-drones 0
  set currently-warehouses 0
  set packages-left 10
  set packages-dropped 0
  set packages-damaged 0
  set time 6 * 60 + 1
  ask patches [
    set road 0
    set passable? true
    set pcolor 67
    set distance-to-factory 0
    set distance-to-house 0
  ...
  ask patches [
    ...
    set distance-to-factory distance-nowrap one-of factories
    set distance-to-airport distance-nowrap one-of airports
    set distance-to-forest distance-nowrap one-of forests
    set distance-to-square distance-nowrap one-of squares
    set altitude random 250
...
to run-simulation
  if packages-dropped = 10 [stop]
  if time = 6 * 60 [ask patches with [pcolor = green - 4] [set pcolor 67]]
  if time = 18 * 60 [ask patches with [pcolor = 67] [set pcolor green - 4]]
  create-people-randomly
  ask forests [if any? drones-on neighbors [set damage random 100]]
  ask airports [if any? drones-on neighbors [set damage random 100]]
  ask squares [if any? drones-on neighbors [set damage random 100]]

  ask houses [set distance-to-warehouse distance one-of warehouses execute-house-behaviour]
  ask drones [execute-drone-behaviour]
  ask people [execute-people-behaviour]
  ask patches [
    ifelse any? people [
      set distance-to-nearest-person distance min-one-of people [distance myself]
    ]
    [
      set distance-to-nearest-person 0
    ]
  ]

  if time = 1440 [set time 0]
  set time time + 1
  tick
end
...
to-report flight-time
  ...
  report (word pad(time / 60) ":" pad(time mod 60))
end
...
false
0
Circle -13345367 true false 163 133 32
Circle -13345367 true false 163 193 62
Circle -13345367 true false 58 193 62
Circle -13345367 true false 88 133 32
Circle -13345367 true false 105 75 58
Circle -13345367 true false 120 75 58
Polygon -7500403 true true 75 255 45 225 240 225 210 255 75 255 75 255
Polygon -7500403 true true 120 225 120 195 165 195 165 225
Polygon -16777216 true false 120 195 120 195 75 165
Polygon -7500403 true true 120 195 75 150 195 150 210 150 165 195
Polygon -13345367 true false 135 90 75 30 90 30 135 75 135 -15 150 -15 150 75 195 30 210 30 150 90
Polygon -7500403 true true 120 165 120 135 165 135 165 165
Polygon -7500403 true true 120 135 75 90 195 90 210 90 165 135
...
